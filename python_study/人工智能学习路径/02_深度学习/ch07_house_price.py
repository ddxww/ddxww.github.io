...
# 4.模型训练
def train_test(model,train_dataset,test_dataset,lr,epochs,batch_size,device):
    # 1.初始化相关操作
...
epochs=200
batch_size=64
train_loss_list,test_loss_list=train_test(model,train_dataset,test_dataset,lr,epochs,batch_size,device)
